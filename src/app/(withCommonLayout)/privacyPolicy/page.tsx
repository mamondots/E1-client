...
const page = () => {
  return (
    <div>
      <PageSection second="Privacy Policy" />
      <div className="Container py-6 lg:mt-4">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <div className="policy-page-text">
            Mamondots respects and protects the privacy of our customers and
            users who visit our websites. Mamondots knows that you care how
          ...
          <div className="policy-page-text ">
            ...
            the services provided by Mamondots.com you agree to the collection
            and use of your data by Mamondots.com in the manner provided in this
            Privacy Policy.
          </div>
          ...
          <div className="policy-page-text">
            ...
            <ul className="policy-page-li">
              ...
              <li>
                ...
                contests to indicate a players progress through the promotion
          ...
          <div className="">
            ...
            <ul className="policy-page-text policy-page-li">
              ...
              <li>
                ...
                safety or security of any person, violations of Mamondots.com s
                terms of use or to defend against legal claims
              </li>
              <li>
          ...
          <div>
            ...
            <div className="policy-page-text">
              ...
              Mamondots.com reserves the right to send you certain service
              related communication, considered to be a part of your
              Mamondots.com account without offering you the facility to
          ...
          <div className="policy-page-text">
            ...
            you at any stage want to delete your personal data from Mamondots,
            across all platforms, you have the full right to do so. Please send
            an email to support@Mamondots.com, we will process your request
